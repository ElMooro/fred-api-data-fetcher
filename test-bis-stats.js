/**
 * Test script for BIS SDMX RESTful API client
 */
const { testBisStatsClient } = require('./src/services/bis-stats-client');

console.log('Testing BIS SDMX RESTful API client...');
testBisStatsClient()
  .then(results => {
